...
| **Instructor** | ผู้สอน อ้างอิงจาก Employee (HR module) หรือกรอก string ก็ได้ |
...
- Drag-and-drop ย้าย schedule (เฉพาะ MGR, ADM, TEC)
...
| Action | OWNER | MGR | ADM | TEC | ACC | SLS | AGT | STF | MKT | HR | PUR | PD |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| ดู Package Catalog | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y | Y |
| สร้าง/แก้ไข Package | Y | Y | Y | Y | - | - | - | - | - | - | - | Y |
| สร้าง/แก้ไข Course | Y | Y | Y | Y | - | - | - | - | - | - | - | Y |
| สร้าง Enrollment | Y | Y | Y | - | - | Y | Y | - | - | - | - | - |
| Confirm Enrollment | Y | Y | Y | - | - | - | - | - | - | - | - | - |
| Cancel Enrollment | Y | Y | Y | - | - | - | - | - | - | - | - | - |
| จัด CourseSchedule | Y | Y | Y | Y | - | - | - | - | - | - | - | - |
| แก้ไข Schedule (drag-drop) | Y | Y | Y | Y | - | - | - | - | - | - | - | - |
| Mark Attendance (manual) | Y | Y | Y | - | - | - | - | Y | - | - | - | - |
| ดู Attendance Report | Y | Y | Y | Y | Y | - | - | Y | - | - | - | - |
| ดู Certificate | Y | Y | Y | Y | Y | Y | Y | Y | - | - | - | - |
| Re-issue Certificate | Y | Y | Y | - | - | - | - | - | - | - | - | - |
| ดู Enrollment Report | Y | Y | Y | Y | Y | Y | - | - | Y | - | - | - |

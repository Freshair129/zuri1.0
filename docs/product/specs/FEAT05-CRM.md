...
Enrollment (course) ───┘                                       MANAGER / SALES
```
...
- Tag ลบได้เฉพาะ MANAGER (ป้องกัน cascade กระทบ customer อื่น)
- ใช้ tag สำหรับ:
...
- **MANAGER-06:** ในฐานะผู้จัดการ ฉันต้องการรับ notification ทันทีเมื่อ AI ตรวจจับว่าลูกค้าพร้อมซื้อ
- **OWN-08:** ในฐานะเจ้าของ ฉันต้องการให้ระบบส่ง reminder ชำระเงินอัตโนมัติเมื่อ student ลงทะเบียนแล้วยังไม่จ่ายภายใน 48 ชม.
- **MANAGER-07:** ในฐานะผู้จัดการ ฉันต้องการดูสถิติว่า workflow ไหน trigger ไปกี่ครั้ง มี conversion กี่ %
...
- ข้อมูลส่วนตัว (phone, email) — เฉพาะ MANAGER/SALES export ได้
...
| Role | สิทธิ์ |
|---|---|
| **SALES** | ดู + แก้ไข customer ที่ assign ให้ตัวเอง, เปลี่ยน stage, เพิ่ม/ลบ tag, บันทึก note, export (ข้อมูลของตัวเอง) |
| **MANAGER** | CRUD ลูกค้าทุกคน, merge customer, bulk operations, สร้าง segment, import/export ทั้งหมด, ลบ tag |
| **FINANCE** | ดูลูกค้า + ประวัติ payment เท่านั้น (read-only) |
| **STAFF, KITCHEN** | ดูอย่างเดียว — ไม่แก้ไข |
| **DEV** | Full access (dev/support) |
| **OWNER** | Full access |
